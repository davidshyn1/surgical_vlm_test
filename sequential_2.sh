...
BACKEND=internvl3.5 DEVICE_VISIBLE=1 bash grounding_task.sh language_grounding_surgical_prompts
BACKEND=paligemma2 DEVICE_VISIBLE=1 bash grounding_task.sh language_grounding_surgical_prompts
BACKEND=qwen3-4b DEVICE_VISIBLE=1 bash grounding_task.sh language_grounding_surgical_prompts
BACKEND=qwen3-32b DEVICE_VISIBLE=1 bash grounding_task.sh language_grounding_surgical_prompts
BACKEND=cosmos-2b DEVICE_VISIBLE=1 bash grounding_task.sh language_grounding_surgical_prompts
BACKEND=qwen3-4b DEVICE_VISIBLE=1 MODEL_ID=khtks/Qwen3-VL/surgsigma_qwen3vl_full   bash grounding_task.sh language_grounding_surgical_prompts
